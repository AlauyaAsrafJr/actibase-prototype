...
export default function PlayerProfile() {
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      const updated = await api.patch("/player/profile", payload);
      setForm(updated);
      setSaved(true);
    } catch (err) {
  ...
  return (
    <div>
      <PageHeader title="Profile" subtitle="Your player account." />
          ...
          <Card.Body>
            ...
            <Form onSubmit={handleSave}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control value={form.year || ""} onChange={(e) => setForm({ ...form, year: e.target.value })} />
              </Form.Group>
              <Form.Group className="mb-3">
